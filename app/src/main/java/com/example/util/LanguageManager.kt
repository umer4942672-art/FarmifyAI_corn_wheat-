...
object AppStrings {
    ...
    private val stringMap = mapOf(
        ...
        "disease_alerts" to Pair("Crop Disease Alerts", "فصل کی بیماری کے الرٹ"),
        "weather_alerts_sub" to Pair("Rain and storm warnings for your district", "آپ کے ضلع میں بارش اور طوفان کی اطلاع"),
        "mandi_alerts_sub" to Pair("Morning price changes for your crops", "صبح آپ کی فصلوں کے ریٹ کی تبدیلی"),
        "khata_reminder_sub" to Pair("Evening reminder to record the day", "شام کو دن کا حساب لکھنے کی یاد دہانی"),
        "disease_alerts_sub" to Pair("Outbreak warnings in your area", "آپ کے علاقے میں بیماری پھیلنے کی اطلاع"),
        "language_title" to Pair("App language", "ایپ کی زبان"),
        "language_sub" to Pair("Applies to the whole app", "پوری ایپ پر لاگو ہوگی"),
